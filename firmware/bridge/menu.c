...
typedef enum { INACTIVE = 1, MAIN_MENU, ARM_MENU, MOTOR_MENU, EXP_MENU, ARM_MENU_WORK, MOTOR_MENU_WORK} MENU_STATE;
...
static void batteryDisplay()
{
	...
	// aka itoa
	for(index = 9; index >= 6; index--) if(index != 8)
	{
...
void menuCheckButtons()
{
	...
	switch(mainMenuSelector)
	{
		...
		case MAIN_MENU:
			...
			{
				case ARM_MENU: lcd_puts_P("< ARM DRIVER >"); break;
				case MOTOR_MENU: lcd_puts_P("< MOTOR DRIVER >"); break;
				case EXP_MENU: lcd_puts_P("< I2C EXPANDER >"); break;
			}
			checkSelector(ARM_MENU, EXP_MENU);

			if(buttonPressed(BUTTON_ENTER))
			{
				mainMenuSelector = subMenuSelector;
		...
		case ARM_MENU:
			...
			switch(subMenuSelector)
			{
				case 1: lcd_puts_P("< CALIBRATE >"); break;
				case 2: lcd_puts_P("< SHOULDER >"); break;
				case 3: lcd_puts_P("< ELBOW >"); break;
				case 4: lcd_puts_P("< WRIST >"); break;
				case 5: lcd_puts_P("< GRIPPER >"); break;
				case 6: lcd_puts_P("< EXIT >"); break;
			}
		...
		case MOTOR_MENU:
			...
			switch(subMenuSelector)
			{
				case 1: lcd_puts_P("< LEFT WHEEL >"); break;
				case 2: lcd_puts_P("< RIGHT WHEEL >"); break;
				case 3: lcd_puts_P("< BOTH WHEELS >"); break;
				case 4: lcd_puts_P("< EXIT >"); break;
			}
